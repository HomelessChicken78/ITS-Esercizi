...
public class Ex_02 {
	public static void main(String[] args) {
		/*
		 * Given an array A of n integers as input, create a second array B of the same
		 * size and populate it by reversing the order of the elements of the first.
		 * Example: if A is (10, 27, 13, 4), then I need to obtain B (4, 13, 27, 10).
