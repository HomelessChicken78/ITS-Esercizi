...
Metodi:
    ...
    rent(): Contrassegna il film come noleggiato se non è già noleggiato. Se il film non è già noleggiato imposta is_rented a True,
...
class VideoRentalStore:
    ...
    def get_rented_movies(self, customer_id: str) -> list[Movie]|None:
